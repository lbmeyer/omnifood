...
var MobileMenu = function () {
  function MobileMenu() {
    ...
    this.mobileMenuIcon = (0, _jquery2.default)(".site-header-mobile-nav__icon");
    this.mobileNav = (0, _jquery2.default)(".site-header__main-nav");
      ...
      this.itemsToReveal.each(function () {
        ...
        new Waypoint({
          ...
          handler: function handler() {
            ...
            if ((0, _jquery2.default)(currentItem).hasClass("meal-plans--animate")) {
              (0, _jquery2.default)(currentItem).addClass("animated pulse");
            } else {
...
var StickyHeader = function () {
  function StickyHeader() {
    ...
    // For sticky nav
    this.siteNav = (0, _jquery2.default)(".site-header-nav");
    this.headerTriggerElement = (0, _jquery2.default)(".sticky-nav-trigger");
    this.mobileMenuIcon = (0, _jquery2.default)(".site-header-mobile-nav__icon");
    this.createHeaderWaypoint();

    // For smooth scrolling
    this.headerLinks = (0, _jquery2.default)(".site-header-nav a");
    this.heroButtons = (0, _jquery2.default)(".hero-box__cta a");
...
new _RevealOnScroll2.default((0, _jquery2.default)(".section-features"), "50%");
new _RevealOnScroll2.default((0, _jquery2.default)(".city-card"), "50%");
new _RevealOnScroll2.default((0, _jquery2.default)(".app-screen"), "50%");
new _RevealOnScroll2.default((0, _jquery2.default)(".meal-plans--animate"), "50%");
